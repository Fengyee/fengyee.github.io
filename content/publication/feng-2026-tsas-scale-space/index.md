...
publication_types:
- article-journal
publication: In *ACM Transactions on Spatial Algorithms and Systems* (**TSAS**), Vol. 12, Issue 4
doi: '10.1145/3812549'
...
summary: 'A scale-space pipeline for terrain represented as Triangulated Irregular Networks (TINs): scale-aware seam-free sampling, an improved TIN smoothing operator, and a fully parallel GPU algorithm for tracking critical points across scales without global sorting.'
